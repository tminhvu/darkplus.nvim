...
theme.set_highlights = function()
    ...
    hl(0, "MatchParen", { fg = 'NONE', bg = c.context })
    ...
    hl(0, "Constant", { fg = c.vivid_blue, bg = 'NONE', bold = true })
    ...
    hl(0, "DiagnosticVirtualTextHint", { fg = c.gray, bg = c.hint_bg, undercurl = true, italic = true, bold = true })
    hl(0, "DiagnosticVirtualTextInfo", { fg = c.gray, bg = c.info_bg, undercurl = true, italic = true, bold = true })
    hl(0, "DiagnosticVirtualTextWarn", { fg = c.warn, bg = c.warn_bg, undercurl = true, italic = true, bold = true })
    hl(0, "DiagnosticVirtualTextError", { fg = c.error, bg = c.error_bg, undercurl = true, italic = true, bold = true })
    ...
    -- WinBar
    hl(0, "WinBar", { fg = c.green, bg = 'NONE', bold = true })
