...
theme.set_highlights = function()
    ...
    hl(0, "DiagnosticVirtualTextWarn", { fg = c.gray, bg = c.warn_bg, undercurl = true, italic = true, bold = true })
    hl(0, "DiagnosticVirtualTextError", { fg = c.gray, bg = c.error_bg, undercurl = true, italic = true, bold = true })
