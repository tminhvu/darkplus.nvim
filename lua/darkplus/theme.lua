...
theme.set_highlights = function()
    ...
    hl(0, "DiagnosticVirtualTextHint", { fg = c.gray, bg = c.hint_bg, italic = true, bold = true })
    hl(0, "DiagnosticVirtualTextInfo", { fg = c.gray, bg = c.info_bg, italic = true, bold = true })
    hl(0, "DiagnosticVirtualTextWarn", { fg = c.gray, bg = c.warn_bg, italic = true, bold = true })
    hl(0, "DiagnosticVirtualTextError", { fg = c.gray, bg = c.error_bg, italic = true, bold = true })
